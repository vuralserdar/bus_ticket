...
namespace busticket_project
{
    public partial class companyemployeelogin : Form
    {
        ...
        OleDbConnection connection = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=byticket.accdb;"); int employeeid;
        ...
        private void companyemployeelogin_Load(object sender, EventArgs e)
        {
