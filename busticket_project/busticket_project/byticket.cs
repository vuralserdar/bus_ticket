...
namespace busticket_project
{
    public partial class byticket : Form
    {
        ...
        OleDbConnection connection = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=byticket.accdb;");
        ...
        private void byticket_Load(object sender, EventArgs e)
        {
            ...
            listening("SELECT * FROM routes WHERE departuredate >=#"+today.Day+"/"+today.Month+"/"+today.Year+"#");
            panel2.Hide();
            panel1.Hide();
